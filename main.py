...
gamma=1
seed=100
method = 'value_iteration' # this is the method used by the IRL algo for generating a policy
...
# fit IRL
maxent_irl(maindir, N, year, feature_matrices, Tprob, gamma, trajectories, lr,lr_decay,n_iters,n_epochs,seed,ai,ai_type,method,shuffle_training=True,use_prior=False)
